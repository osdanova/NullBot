...
# Imprime el informativo matinal
def informativo(bot, update):
...
# COMANDO: informativo matinal
def cmd_informativo(bot, update):
    animeCaps(bot, update)
...
def main():
    ...
    dp.add_handler(CommandHandler("informativo", cmd_informativo))
